...
class CNNClassifier(nn.Module):
    ...
    def __init__(self, tcr_conv_layers_sizes=[20, 1, 18],
        ...
        for i in range(0, len(tcr_conv_layers_sizes), 4):
            ...
            layer = nn.MaxPool1d(kernel_size=tcr_conv_layers_sizes[i+3],
                                 stride=1)
            outsize = outsize+1-tcr_conv_layers_sizes[i+3]
